...
const LandingPage = () => {
    ...
    return (
        <div>
            <div>
                <Navbar />
                <div className='grid bg-white lg:grid-cols-2 lg:h-[80dvh]'>
                    <div className='flex order-2 lg:order-1 flex-col items-center justify-center gap-3 lg:gap-6 m-16'>
                        <div className=' text-black text-2xl md:text-2xl lg:text-5xl leading-6 font-bold '>
                            <span className='text-black text-center'>Oasis:</span> Speak Up. Be Heard.
                        </div>
                        <div className='text-black flex flex-col gap-5 ml-1 lg:gap-10'>
                            ...
                            <div className='flex items-center gap-8 lg:gap-5 '>
                                <button className='text-white text-md lg:text-lg font-bold bg-black px-4 py-1 lg:px-6 lg:py-3 rounded-md'>
                                    File a report
                                </button>
                                <button className='text-black text-md lg:text-lg border-[1.5px] px-4 py-1 lg:px-7 lg:py-3 rounded-md'>
                                    Learn more
                                </button>
                            </div>
                        </div>
            ...
            <div>
                <div className='bg-black text-white mx-36 my-10 py-8 rounded-lg grid grid-cols-3'>
            ...
            <div className='flex-col gap-3 bg-white text-5xl text-[#fe570b] my-10 flex items-center justify-center '>
                <span>Know what's happening</span>
                <span className='text-black text-4xl'> Oasis: Here's what's going on behind the scenes</span>
            </div>
            
            <div className='grid grid-cols-8 items-center bg-white justify-center mx-8'>
                <div className='flex col-span-2'>
                    <div className='flex flex-col items-center justify-center gap-4'>
                        <button className='bg-[#fe570b] text-xl text-black font-semibold rounded-full w-16 h-16'>
                            1
                        </button>
